...
<html lang="en">
  ...
  <section class="header">
    ...
    <?php
                ...
                ?>
      <form action="./TraitementModifierUsers.php" method="post" class="contact-form">
        ...
        <input type="hidden" name="role" value="<?php echo $value->role ?>" id="role" />
    
        <label for="nom">Email</label>
        <input type="text" name="email" value="<?php echo $value->email ?>" id="email" required/>

        <label for="password">Password</label>
        <input type="password" name="password" id="password" value="<?php echo $value->email ?>" required/>
