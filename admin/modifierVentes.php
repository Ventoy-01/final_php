...
<html lang="en">
  ...
  <section class="header">
    ...
    <?php
                ...
                ?>
                <form action="./TraitementModifierVentes.php" method="post" class="contact-form">
                    ...
                    <input type="text" name="cuisson" id="cuisson"  value="<?php echo $value-> Code_plat?>" disabled/>

                    <label for="quantite">Nombre de Plats</label>
                    <input type="number" name="quantite" id="quantite" value="<?php echo $value->Nonbre_plats?>" required/>
