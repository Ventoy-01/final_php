  ...
  <section class="header">
      <nav>
        <h1>
          ...
          <a href="./index.php">Bonjour, <?php echo $_SESSION['cuisson']." ".$_SESSION['nom'] ?></a>
        </h1>
        <ul>
    ...
    <form action="./TraitementAjouterVentes.php" method="post" class="contact-form">

        <input type="hidden" name="code_vente" value="<?php echo "TRIO-".rand(0001,9000) ?>" />
        
        <label for="nom">Code Client</label>
        <input type="text" name="nom" id="nom" required />

        <label for="cuisson">Code Plat</label>
        <input type="text" name="cuisson" id="cuisson" required/>
