    ...
    <section class="contact">
              ...
              <?php
                    ...
                    if ($query->rowCount()>0) {
                      ...
                      ?>
                      <form action="./TraitementSupprimerVentes.php" method="post" class="contact-form">

                      <input type="hidden" name="codeid" value="<?php echo $_GET['codeid'] ?>" />
                      <label for="nom">Code Client</label>
                      <input type="text" name="nom" id="nom" disabled value="<?php echo $value->Code_client ?>" />

                      <label for="cuisson">Code Plat</label>
                      <input type="text" name="cuisson" id="cuisson" disabled value="<?php echo $value->Code_plat ?>"/>

                      <label for="quantite">Nombre de Plats</label>
                      <input type="number" name="quantite" id="quantite" disabled value="<?php echo $value->Nonbre_plats ?>"/>
