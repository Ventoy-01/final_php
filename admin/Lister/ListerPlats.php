    ...
    <div class="container-fluid">
      ...
      $user = $_SESSION['prenom_user'];
          ...
          if ($query->rowCount()>=1) {
            ...
            echo "<div class='alert alert-danger'>".'Aucune plats'."</div>";
                ...
                ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../Traitement/TraitementSupprimerPlats.php?codeid=<?= $value->code_plat; ?>" class="btn-small btn-small-danger"
